import type { CandidateOut, ProviderChoice } from '../../api/client'
import { Banner } from '../ui/Banner'
import { CandidateCard } from '../ui/CandidateCard'

export function CandidatesStep({ candidates, onContinue, provider = 'demo' }: { candidates: CandidateOut[]; onContinue: () => void; provider?: ProviderChoice }) {
  return (
